...
class Block(nn.Module):
    ...
    def __init__(self, cfg, prefix_exist=False):
        super().__init__()
        ...
        self.prefix_exist = prefix_exist
...
class Decoder(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.transformer = nn.ModuleDict(dict(
            ...
            h = nn.Sequential(*[Block(cfg, prefix_exist=True) for _ in range(cfg.n_layer)]),
            ln_f = nn.LayerNorm(cfg.n_embd)
        ))
        self.prefix_encoder = PrefixEncoder(cfg, 10, True)
