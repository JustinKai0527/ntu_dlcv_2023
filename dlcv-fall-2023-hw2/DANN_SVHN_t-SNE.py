...
if __name__ == "__main__":
    ...
    dataset = USPS_dataset("hw2_data/digits/svhn/data", valid_file, valid_label, valid_tfm, domain=True)
    ...
    with torch.no_grad():
        ...
        plt.title("t-SNE Figure for SVHN Domains")
        plt.legend()
        plt.grid(True)
        plt.savefig("plot/SVHN-domain-tSNE")
