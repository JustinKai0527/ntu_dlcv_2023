...
if __name__ == "__main__":
    ...
    train_data = Mnistm_dataset("hw2_data/digits/mnistm/data", train_file, train_label, train_tfm)
    train_loader = DataLoader(train_data, batch_size=BATCH_SIZE, shuffle=True)
    valid_data = Mnistm_dataset("hw2_data/digits/mnistm/data", valid_file, valid_label, valid_tfm)
    ...
    for ep in range(1, NUM_EPOCH+1):
        ...
        with torch.no_grad():
            ...
            if best_acc < valid_acc:
                ...
                torch.save(model_ckpt, "modelD.pt")
